...
public record RoomDTO(long id, String name, short personCount, short standard) {
    public static RoomDTO toDto(Room room) {
        return new RoomDTO(room.getId(), room.getName(), room.getPersonCount(), room.getStandard());
    }
